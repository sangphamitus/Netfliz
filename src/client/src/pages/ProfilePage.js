    ...
    return(
        <div className="App bg-[#082032]">
            ...
            <div className='flex mx-36 py-14 border-b-2'>
                ...
                <div className='grid'>
                    <div className='pl-12 pr-4 w-[181px] text-right grid'>
                        ...
                        <Text text={'NAME:'} isHeader={false} customTheme={"text-white font-button text-2xl "} />
                        <Text text={'Date of birth:'} isHeader={false} customTheme={"text-white font-button text-2xl "} />
                        <Text text={'ID:'} isHeader={false} customTheme={"text-white font-button text-2xl "} />
                        <Text text={'Email:'} isHeader={false} customTheme={"text-white font-button text-2xl "} />
            ...
            <div className='mx-36 py-14 h-[2000px]'>
                <Text text={'Your playlists'} isHeader={true} customTheme={"text-pink-600 font-button text-4xl "} />
