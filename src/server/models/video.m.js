...
module.exports = {
    addVideo: async ({
        ...
        if (rs.length == 0) {
            ...
            db.any(`insert into  public.\"Videos\"(\"vid\",\"link\",\"name\",\"haveEp\",\"review\",\"type\",\"image\",\"ratting\") 
                VALUES ($1,$2,$3,$4,$5,$6,$7,$8)`, [vid, link, name, haveEp, review, type, 'image/' + vid + '/main.jpg', ratting]);
